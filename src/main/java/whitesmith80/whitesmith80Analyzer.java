 ...
 */
public class whitesmith80Analyzer extends AbstractAnalyzer {

	public whitesmith80Analyzer() {

		// Name the analyzer and give it a description.

		super("Whitesmith80 Analyzer", "Analyzer for whitesmith's 8080 C", AnalyzerType.BYTE_ANALYZER);
	}
	...
	public boolean added(Program program, AddressSetView set, TaskMonitor monitor, MessageLog log)
		...
		// analysis succeeded.
		// grunge through the program looking for the various things we might want to customize
		// specifically, c.ent function calls that allocate stack space
		// and numeric worker function calls
